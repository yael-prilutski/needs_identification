...
DAYS = 'week2_days'
WEEK = 'week2'
PATH = join(RESULTS_PATH, 'svm', 'colored_predict_behavior')
...
class SvmSatiation:
    ...
    def blocks_onsets(self, day_data, day):
        ...
        colors = self.color_trials(relevant_trials, trials_type, day)

        return water_block, food_block, colors

    def color_trials(self, relevant_trials, trials_type, day):
        colors = []
